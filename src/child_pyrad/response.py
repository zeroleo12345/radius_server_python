...
class AuthResponse(AuthPacket):
    ...
    def create_access_accept(cls, request: 'AuthRequest') -> AuthPacket:
        ...
        if request.auth_protocol in [PacketProtocol.CHAP_PROTOCOL, PacketProtocol.PAP_PROTOCOL, PacketProtocol.MAC_PROTOCOL]:
        ...
        if request.auth_protocol in [PacketProtocol.EAP_PEAP_MSCHAPV2_PROTOCOL, PacketProtocol.EAP_PEAP_GTC_PROTOCOL, PacketProtocol.MSCHAPV2_PROTOCOL]:
            reply['Filter-Id'] = f'pay_user_50m'
        return reply
